...
journey in section 5 of the frontend gives the user the option to enter their bank account details or to give a reason why not to.
...
> Documentation: The documentation for the BARS Verify API can be found [here](https://github.com/hmrc/bank-account-reputation/blob/main/public/api/conf/1.0/docs/business/verify.md). It explains the API response values which are used to determine the status in the frontend. 
