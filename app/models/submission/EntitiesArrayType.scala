...
sealed trait EntitiesArrayType

case object GroupMemberEntity extends EntitiesArrayType
case object GroupRepMemberEntity extends EntitiesArrayType
  ...
  implicit val format: Format[EntitiesArrayType] = Format[EntitiesArrayType](
    Reads[EntitiesArrayType] {
      _.validate[String].map {
        ...
        case "2" => GroupRepMemberEntity
        case "3" => PartnerEntity
      }
    },
